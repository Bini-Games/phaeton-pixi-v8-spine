...
export declare class SkeletonBinary {
    ...
    static blendModeFromNumber(num: number): "normal" | "add" | "multiply" | "screen";
}
...
export declare class SkeletonJson {
    ...
    static blendModeFromString(str: string): "normal" | "add" | "multiply" | "screen";
}
