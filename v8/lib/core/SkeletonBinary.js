...
const _SkeletonBinary = class {
  ...
  readSkeletonData(binary) {
    ...
    for (let i = 0; i < n; i++) {
      ...
      data.blendMode = _SkeletonBinary.blendModeFromNumber(input.readInt(true));
  ...
  static blendModeFromNumber(num) {
    if (num == 0)
      return "normal";
    if (num == 1)
      return "add";
...
SkeletonBinary.BlendModeValues = ["normal", "add", "multiply", "screen"];
class LinkedMesh {
