...
import '@pixi-v8-patch-spine/loader-base'; // Side effect install atlas loader
// eslint-disable-next-line @typescript-eslint/no-duplicate-imports
import { ISpineResource, SpineLoaderAbstract } from '@pixi-v8-patch-spine/loader-base';
import type { ISkeletonParser, TextureAtlas } from '@pixi-v8-patch-spine/base';
import { AtlasAttachmentLoader, SkeletonBinary, SkeletonData, SkeletonJson } from '@pixi-v8-patch-spine/runtime-4.0';
